function associarProduto(codigo){
    ...
    */
    listaProdutos = [['01','Porta chaves 1CM', '3,00€', ['False'], ['https://www.theuncomfortable.com/wp-content/uploads/2018/10/Ruler-1024x1024.jpg'],3],
                     ['02','Conjunto Vasos Caneca Longa', '15,00€', ['True', '20,00€', '25%'], ['https://www.theuncomfortable.com/wp-content/uploads/2017/05/teaset_01_p-1024x687.jpg','https://www.theuncomfortable.com/wp-content/uploads/2017/04/24_long_mug.jpg'],4.5]]
    ...
    for (let i of listaProdutos){
        ...
        if (i[0] == codigo){
            ...
            if (i[3][0] == 'True'){
                ...
                document.getElementById('descontoProdutoDestacado').innerHTML = `${i[3][2]} de DESCONTO!!!`
